      ...
      <div className="footer">
        <div className="footer__block">
          ...
          <span className="footer__legal">
            <div>Copyright &copy; 2018 - 2019 <a href="https://ittrium.io/">Ittrium Cryptocurrency</a></div>
            <div>Site design / Logo &copy; 2018 - 2019 <a href="https://ittrium.io/">Ittrium Cryptocurrency</a></div>
          </span>
        </div>
        <div className="footer__block">
        ...
        <div className="footer__block">
          <div className="footer__social-media-wrapper">
            ...
            <div>
              ...
              <a href="https://t.me/ittriumcrypto" target="_blank">
                <Icon name="telegram" className="fab footer__social-media-icon" />
              </a>
              <a href="https://www.reddit.com/r/IttriumCoin/" target="_blank">
                <Icon name="reddit" className="fab footer__social-media-icon" />
              </a>
              <a href="https://github.com/IttriumCore" target="_blank">
                <Icon name="github" className="fab footer__social-media-icon" />
              </a>
              <a href="https://twitter.com/IttriumCrypto" target="_blank">
