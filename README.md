![Ittrium Logo](https://ittrium.io/wp-content/uploads/2018/04/blockexplorer.svg)

Ittrium Explorer
&middot;
[![GitHub license](https://img.shields.io/github/license/IttriumCore/ittrium-explorer.svg)](https://github.com/IttriumCore/ittrium-explorer/blob/master/COPYING) [![Build Status](https://travis-ci.org/IttriumCore/ittrium-explorer.svg?branch=master)](https://travis-ci.org/IttriumCore/ittrium-explorer) [![Discord](https://img.shields.io/discord/374271866308919296.svg)](https://discord.me/ittriumcrypto) [![GitHub version](https://badge.fury.io/gh/IttriumCore%2Fittrium-explorer.svg)](https://badge.fury.io/gh/IttriumCore%2Fittrium-explorer)
=====
...
It is also required to have the Ittrium daemon running in the background. It is recommended to set this up before beginning to set up the explorer so that it syncs by the time you need it.

Our geniuses here at IttriumCorp™ have put together a script to do this for you. Just run

`bash script/ittriumd_setup.sh`

This will install the latest Ittrium wallet and create a rpc username/password before starting the daemon.

## Install
`git clone https://github.com/IttriumCore/ittrium-explorer.git` - copy repo to local folder.
