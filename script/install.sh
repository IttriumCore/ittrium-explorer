...
server {
    ...
    #server_name explorer.ittrium.io;
    server_name _;
    ...
    #ssl_certificate /etc/letsencrypt/live/explorer.ittrium.io/fullchain.pem; # managed by Certbot
    #ssl_certificate_key /etc/letsencrypt/live/explorer.ittrium.io/privkey.pem; # managed by Certbot
    #include /etc/letsencrypt/options-ssl-nginx.conf; # managed by Certbot
    #ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem; # managed by Certbot
}

#server {
#    if ($host = explorer.ittrium.io) {
...
installIttrium () {
    ...
    cd
    rm -rf /tmp/ittrium
    mkdir -p /home/explorer/.ittrium
    cat > /home/explorer/.ittrium/ittrium.conf << EOL
rpcport=52544
rpcuser=$rpcuser
...
txindex=1
EOL
    sudo cat > /etc/systemd/system/ittriumd.service << EOL
[Unit]
...
ExecStart=/home/explorer/bin/ittriumd -datadir=/home/explorer/.ittrium
ExecStop=/home/explorer/bin/ittrium-cli -datadir=/home/explorer/.ittrium stop
Restart=on-abort
[Install]
...
installBlockEx () {
    ...
    git clone https://github.com/IttriumCore/ittrium-explorer.git /home/explorer/blockex
